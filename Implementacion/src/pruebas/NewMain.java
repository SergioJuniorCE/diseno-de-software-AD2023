...
public class NewMain {
    ...
    public static void main(String[] args) {
        ...
        // podemos ver que empresas de transporte participaron, el residuo es el mismo ya que solo se puede mandar 1 residuo por seguridad
        //    y podemos ver informacion de cada translado. De la empresa productora solo interesa saber su id porque para cada translado 
